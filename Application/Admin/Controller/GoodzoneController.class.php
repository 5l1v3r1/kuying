...
use Org\Util\Auth;
class GoodzoneController extends CommonController
{
	...
	public function insert()
	{
		$user=M('zone');
		$where['TIME'] = time();
		$where['LIST'] = I('LIST','','htmlspecialchars');
		$where['ZONE_NAME'] = I('ZONE_NAME','','htmlspecialchars');
		$where['CONTENT']=I('CONTENT','','htmlspecialchars');
