...
class GoodsController extends CommonController
{
	...
	public function insert()
	{
		...
		$where['GOOD_SORT'] = I('GOOD_SORT','','htmlspecialchars');
		$where['INFO_TXT']=I('INFO_TXT','','htmlspecialchars');
		$where['INFO_IMG'] = I('INFO_IMG','','strip_tags');
		$where['GOOD_SRC']=I('GOOD_SRC','','htmlspecialchars');
		//$where['INFO_IMG']=$_POST['INFO_IMG'];
		//$where['GOOD_SRC']=$_POST['GOOD_SRC'];
		$where['OR_INDEX']=I('OR_INDEX','','htmlspecialchars');
