  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">电视剧下载专区<small> 发掘，提供，分享 we do it</small></h3>
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	<!--left-->
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
		    		...
		    		<a href="<?php echo U('Index/showJuList?type=3300&p=1');;?>">电视剧下载专区</a>
		    	</h6>
		    	<hr>
      		<?php if(I('get.p') == 1): ?><img width="100%" src="/kuying/Public/img/BTzone/4.gif">
      		<h4 color="#fafafa"><img src="/kuying/Public/img/icon/hotrec.gif">热门推荐<small> 高清电视剧倾情推荐</small></h4>
      		<!--BT TOP -->
											   ...
											   <tbody>
											   	<?php if(is_array($listtop)): foreach($listtop as $key=>$vo): ?><tr>
											         ...
											         <td>
											         	...
											         	<a href="<?php echo U('Index/showJucontent?fid='.$vo[FID].'');;?>">
											         		<?php echo ($vo["FNAME"]); ?>		
											         	</a>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showJuList?type=3300&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showJuList?type=3301&p=1');;?>" class="btn btn-default">大陆</a>
		            <a href="<?php echo U('Index/showJuList?type=3302&p=1');;?>" class="btn btn-default">港台</a>
		            <a href="<?php echo U('Index/showJuList?type=3303&p=1');;?>" class="btn btn-default">欧美</a>
		            <a href="<?php echo U('Index/showJuList?type=3304&p=1');;?>" class="btn btn-default">日剧</a>
		            <a href="<?php echo U('Index/showJuList?type=3305&p=1');;?>" class="btn btn-default">韩剧</a>
		            <a href="<?php echo U('Index/showJuList?type=3306&p=1');;?>" class="btn btn-default">其它</a>
