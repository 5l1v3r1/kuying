    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:50px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-9" style="padding-left:5px;margin-left:0px;" >
      		<!--bt-->
      		<h4 color="#fafafa"><img src="/kuying/Public/img/icon/person.gif"><strong >&nbsp会员福利</strong><small> 仔细看看吧!</small></h4>
      		<!--BT start -->
	      	<div class="row" style="padding:0px;margin-left:0px;background-color:#fafafa;" >
	      		<div class="panel panel-primary">
					   <div class="panel-heading">
					      <h3 class="panel-title">获赠积分和礼物</h3>
					   </div>
					   <div class="panel-body">
					     <h4>1. 注册会员即可获赠30个积分</h4> 
					     <h4>2. 注册会员每天签到即可获赠5个积分</h4> 
					     <h4>3. 会员可以参加每天最多三次的抽奖活动获取积分等礼物</h4> 
					     <h4>4. 网站不定期会通过微信公众平台等向会员发放电影票等礼物哦</h4> 
					   </div>
						</div>
						<div class="panel panel-primary">
					   <div class="panel-heading">
					      <h3 class="panel-title">下载资源</h3>
					   </div>
					   <div class="panel-body">
					     <h4>1. 会员才能下载酷影网的资源</h4> 
					     <h4>2. 会员才能参与抽奖及签到等网站活动</h4> 
					   </div>
						</div>
						<div class="panel panel-primary">
					   <div class="panel-heading">
					      <h3 class="panel-title">购买积分</h3>
					   </div>
					   <div class="panel-body">
					     <h4>· 会员如果实在太懒没有积分，通过支付宝也可以获取积分哦</h4> 
					     <h4>· 积分售价： </h5> 
					     <h5>————————10元= 50个积分 </h5> 
					     <h5>————————20元= 110个积分 </h5> 
					     <h5>————————30元= 170个积分 </h5> 
					     <h5>————————50元= 290个积分 </h5>
					     <h5>————————100元= 600个积分 </h5>
					     <h4>· 付款方法：联系站长QQ：1448474396，站长确认后会提供网站的支付宝账号！</h5> 
					   </div>
						</div>
						<div class="panel panel-primary">
					   <div class="panel-heading">
					      <h3 class="panel-title">其它福利</h3>
					   </div>
					   <div class="panel-body">
					     <h4>1. 网站运营成熟后，会采用邀请码注册制度，会员能够免费获赠邀请码</h4> 
					     <h4>2. 其它福利会及时补充</h5> 
					   </div>
						</div>
	        </div>
