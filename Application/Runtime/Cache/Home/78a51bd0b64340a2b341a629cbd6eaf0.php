  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">BD高清电影下载<small> 发掘，提供，分享 we do it</small></h3>
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
		    		...
		    		<a href="<?php echo U('Index/showBDList?type=1200&p=1');;?>">BD高清电影下载</a>
		    	</h6>
      		<hr>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showBDList?type=1200&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showBDList?type=1201&p=1');;?>" class="btn btn-default">冒险</a>
		            <a href="<?php echo U('Index/showBDList?type=1202&p=1');;?>" class="btn btn-default">动作</a>
		            <a href="<?php echo U('Index/showBDList?type=1203&p=1');;?>" class="btn btn-default">犯罪</a>
		            <a href="<?php echo U('Index/showBDList?type=1204&p=1');;?>" class="btn btn-default">动画</a>
		            <a href="<?php echo U('Index/showBDList?type=1205&p=1');;?>" class="btn btn-default">家庭</a>
		            <a href="<?php echo U('Index/showBDList?type=1206&p=1');;?>" class="btn btn-default">爱情</a>
		            <a href="<?php echo U('Index/showBDList?type=1207&p=1');;?>" class="btn btn-default">奇幻</a>
		            <a href="<?php echo U('Index/showBDList?type=1208&p=1');;?>" class="btn btn-default">恐怖</a>
		            <a href="<?php echo U('Index/showBDList?type=1209&p=1');;?>" class="btn btn-default">剧情</a>
		            <a href="<?php echo U('Index/showBDList?type=1210&p=1');;?>" class="btn btn-default">科幻</a>
		            <a href="<?php echo U('Index/showBDList?type=1211&p=1');;?>" class="btn btn-default">悬疑</a>
		            <a href="<?php echo U('Index/showBDList?type=1212&p=1');;?>" class="btn btn-default">战争</a>
		            <a href="<?php echo U('Index/showBDList?type=1213&p=1');;?>" class="btn btn-default">悬念</a>
		            <a href="<?php echo U('Index/showBDList?type=1214&p=1');;?>" class="btn btn-default">喜剧</a>
		            <a href="<?php echo U('Index/showBDList?type=1215&p=1');;?>" class="btn btn-default">惊悚</a>
		            <a href="<?php echo U('Index/showBDList?type=1216&p=1');;?>" class="btn btn-default">传记</a>
		            <a href="<?php echo U('Index/showBDList?type=1217&p=1');;?>" class="btn btn-default">合集</a>
		            <a href="<?php echo U('Index/showBDList?type=1218&p=1');;?>" class="btn btn-default">综艺</a>
		            <a href="<?php echo U('Index/showBDList?type=1220&p=1');;?>" class="btn btn-default">其它</a>
