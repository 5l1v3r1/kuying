  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">美剧下载专区<small> 发掘，提供，分享 we do it</small></h3>
    	...
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
		    		...
		    		<a href="<?php echo U('Index/showJuList?type=3400&p=1');;?>">美剧下载专区</a>
		    	</h6>
		    	<hr>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
	        			<a href="<?php echo U('Index/showJuList?type=3400&p=1');;?>" class="btn btn-default">全部</a>
								<a href="<?php echo U('Index/showJuList?type=3407&p=1');;?>" class="btn btn-default">分集</a>
		            <a href="<?php echo U('Index/showJuList?type=3408&p=1');;?>" class="btn btn-default">连载</a>
		            <a href="<?php echo U('Index/showJuList?type=3409&p=1');;?>" class="btn btn-default">完结</a>
		            <a href="<?php echo U('Index/showJuList?type=3406&p=1');;?>" class="btn btn-default">其它</a>
