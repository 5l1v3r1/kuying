...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:wb="http://open.weibo.com/wb" lang="zh-CN">
  <head>
    ...
    <meta name="description" content="高清,1080p,720p,蓝光,3D,爱微淘">
    	...
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-9" style="padding-left:5px;margin-left:0px;" >
	      	...
	      	<div class="row" style="padding:0px;margin-left:0px;background-color:#fafafa;" >
		        	...
		        	<div class="col-md-12"  style="padding:8px;padding-bottom:0px;margin-left:0px;">
	          		<div class="thumbnail" >
			            <div class="caption" >
			              ...
			              <strong ><span class="label label-primary">Hot</span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=1600&p=1');;?>"> 1080pBT分享专区</a></strong><br>
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-warning">Hot</span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=1700&p=1');;?>"> 720pBT分享专区</a></strong><br>
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-primary"> RD </span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=1900&p=1');;?>"> REMUX/原盘BT分享专区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-warning"> CD </span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=2000&p=1');;?>"> 高清合集BT分享专区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-primary">Hot</span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=1800&p=1');;?>"> 百度/360网盘分享专区</a></strong><br>
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-warning"> VD </span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=2100&p=1');;?>"> 高清记录片BT分享专区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			              <strong><span class="label label-primary">3D </span>&nbsp&nbsp<a href="<?php echo U('Index/showHDList?type=2200&p=1');;?>"> 3D高清电影BT分享专区</a></strong><br>
			              <div style="border-bottom:1px solid #999;margin-bottom:6px; "></div>
			            </div>
	          		</div>	
	        		</div>
	        		<div class="col-md-12"  style="padding:8px;padding-bottom:0px;margin-left:0px;">
	          		<div class="thumbnail" >
			            ...
			            <div class="caption" >
			              ...
			              <div style="border-bottom:1px solid #999;margin-bottom:8px; "></div>
			              <strong><span class="label label-primary">4</span>&nbsp&nbsp<a href="<?php echo U('Index/showZYList?type=400&p=1');;?>"> 欧美高清综艺分享区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:8px; "></div>
			              ...
			              <div style="border-bottom:1px solid #999;margin-bottom:8px; "></div>
			              <strong><span class="label label-primary">6</span>&nbsp&nbsp<a href="<?php echo U('Index/showZYList?type=600&p=1');;?>"> 动漫高清分享区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:8px; "></div>
			            </div>
			          </div>	
	        		...
	        		<div class="col-md-12"  style="padding:8px;padding-top:0px;padding-bottom:0px;margin-left:0px;">
	          		<div class="thumbnail" >
			            <div class="caption" >
	          	...
	          	<div class="col-md-12"  style="padding:8px;padding-top:0px;padding-bottom:0px;margin-left:0px;">
	          		<div class="thumbnail" >
			            <div class="caption" >
			              ...
			              <br> 
			              <strong><span class="label label-primary">2</span>&nbsp&nbsp<a href="<?php echo U('Index/showJuList?type=3400&p=1');;?>"> 美剧下载专区</a></strong><br> 
			              <div style="border-bottom:1px solid #999;margin-bottom:4px; "></div>
			              <br> 
			            </div>
			          </div>
