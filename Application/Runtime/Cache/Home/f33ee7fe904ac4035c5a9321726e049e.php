  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">百度/360网盘分享专区<small> 发掘，提供，分享 we do it</small></h3>
    		<h6>
      		<a href="<?php echo U('Index/index');;?>"><img src="/kuying/Public/img/icon/index.gif" width=16px > 首 页/</a>
      		<a href="<?php echo U('Index/showBTZone');;?>">BT共享区/</a>
      		<a href="<?php echo U('Index/showHDList?type=1800&p=1');;?>">百度/360网盘分享专区</a>
      	</h6>
      	<hr>
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showHDList?type=1800&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showHDList?type=1801&p=1');;?>" class="btn btn-default">冒险</a>
		            <a href="<?php echo U('Index/showHDList?type=1802&p=1');;?>" class="btn btn-default">动作</a>
		            <a href="<?php echo U('Index/showHDList?type=1803&p=1');;?>" class="btn btn-default">犯罪</a>
		            <a href="<?php echo U('Index/showHDList?type=1804&p=1');;?>" class="btn btn-default">动画</a>
		            <a href="<?php echo U('Index/showHDList?type=1805&p=1');;?>" class="btn btn-default">家庭</a>
		            <a href="<?php echo U('Index/showHDList?type=1806&p=1');;?>" class="btn btn-default">爱情</a>
		            <a href="<?php echo U('Index/showHDList?type=1807&p=1');;?>" class="btn btn-default">奇幻</a>
		            <a href="<?php echo U('Index/showHDList?type=1808&p=1');;?>" class="btn btn-default">恐怖</a>
		            <a href="<?php echo U('Index/showHDList?type=1809&p=1');;?>" class="btn btn-default">剧情</a>
		            <a href="<?php echo U('Index/showHDList?type=1810&p=1');;?>" class="btn btn-default">科幻</a>
		            <a href="<?php echo U('Index/showHDList?type=1811&p=1');;?>" class="btn btn-default">悬疑</a>
		            <a href="<?php echo U('Index/showHDList?type=1812&p=1');;?>" class="btn btn-default">战争</a>
		            <a href="<?php echo U('Index/showHDList?type=1813&p=1');;?>" class="btn btn-default">悬念</a>
		            <a href="<?php echo U('Index/showHDList?type=1814&p=1');;?>" class="btn btn-default">喜剧</a>
		            <a href="<?php echo U('Index/showHDList?type=1815&p=1');;?>" class="btn btn-default">惊悚</a>
		            <a href="<?php echo U('Index/showHDList?type=1816&p=1');;?>" class="btn btn-default">传记</a>
		            <a href="<?php echo U('Index/showHDList?type=1817&p=1');;?>" class="btn btn-default">合集</a>
		            <a href="<?php echo U('Index/showHDList?type=1818&p=1');;?>" class="btn btn-default">综艺</a>
		            <a href="<?php echo U('Index/showHDList?type=1819&p=1');;?>" class="btn btn-default">电视剧</a>
		            <a href="<?php echo U('Index/showHDList?type=1820&p=1');;?>" class="btn btn-default">其它</a>
