  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">日本高清综艺分享专区<small> 发掘，提供，分享 we do it</small></h3>
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	<!--left-->
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
	      		...
	      		<a href="<?php echo U('Index/showZYList?type=200&p=1');;?>">日本高清综艺分享专区</a>
	      	</h6>
	      	<hr>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showZYList?type=200&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showZYList?type=201&p=1');;?>" class="btn btn-default">1080p</a>
		            <a href="<?php echo U('Index/showZYList?type=202&p=1');;?>" class="btn btn-default">720p</a>
