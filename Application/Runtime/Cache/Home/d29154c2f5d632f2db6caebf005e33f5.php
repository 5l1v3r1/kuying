  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">3D高清电影BT分享专区<small> 发掘，提供，分享 we do it</small></h3>
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	<!--left-->
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
	      		...
	      		<a href="<?php echo U('Index/showHDList?type=2200&p=1');;?>">3D高清电影BT分享专区</a>
	      	</h6>
      		<hr>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showHDList?type=2200&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showHDList?type=2221&p=1');;?>" class="btn btn-default">左右格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2222&p=1');;?>" class="btn btn-default">上下格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2223&p=1');;?>" class="btn btn-default">红蓝格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2224&p=1');;?>" class="btn btn-default">交错格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2225&p=1');;?>" class="btn btn-default">红绿格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2226&p=1');;?>" class="btn btn-default">绿红格式</a>
		            <a href="<?php echo U('Index/showHDList?type=2227&p=1');;?>" class="btn btn-default">3D原盘</a>
		            <a href="<?php echo U('Index/showHDList?type=2228&p=1');;?>" class="btn btn-default">未知原盘</a>
		            <a href="<?php echo U('Index/showHDList?type=2220&p=1');;?>" class="btn btn-default">其它</a>
