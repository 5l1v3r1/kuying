  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">演唱会/MV/运动体育/音乐 分享专区<small> 发掘，提供，分享 we do it</small></h3>
    	...
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	...
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
	      		...
	      		<a href="<?php echo U('Index/showZYList?type=500&p=1');;?>">演唱会/MV/运动体育/音乐 分享专区</a>
	      	</h6>
	      	<hr>
      		<?php if(I('get.p') == 1): ?><img width="100%" src="/kuying/Public/img/BTzone/2.gif">
											   ...
											   <tbody>
											   	<?php if(is_array($listtop)): foreach($listtop as $key=>$vo): ?><tr>
											         ...
											         <td>
											         	...
											         	<a href="<?php echo U('Index/showZYcontent?fid='.$vo[FID].'');;?>">
											         		<?php echo ($vo["FNAME"]); ?>		
											         	</a>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showZYList?type=500&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showZYList?type=505&p=1');;?>" class="btn btn-default">MV</a>
		            <a href="<?php echo U('Index/showZYList?type=506&p=1');;?>" class="btn btn-default">体育</a>
		            <a href="<?php echo U('Index/showZYList?type=507&p=1');;?>" class="btn btn-default">综艺</a>
		            <a href="<?php echo U('Index/showZYList?type=508&p=1');;?>" class="btn btn-default">MTV</a>
		            <a href="<?php echo U('Index/showZYList?type=509&p=1');;?>" class="btn btn-default">演唱会</a>
		            <a href="<?php echo U('Index/showZYList?type=510&p=1');;?>" class="btn btn-default">音乐</a>
		            <a href="<?php echo U('Index/showZYList?type=511&p=1');;?>" class="btn btn-default">其它</a>
