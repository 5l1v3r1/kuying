  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">ipad等MP4小容量电影下载专区<small> 发掘，提供，分享 we do it</small></h3>	
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	<!--left-->
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
	      		...
	      		<a href="<?php echo U('Index/showBDList?type=1100&p=1');;?>">ipad等MP4小容量电影下载专区</a>
	      	</h6>
	      	<hr>
      		<?php if(I('get.p') == 1): ?><img width="100%" src="/kuying/Public/img/BTzone/3.gif">
											   ...
											   <tbody>
											   	<?php if(is_array($listtop)): foreach($listtop as $key=>$vo): ?><tr>
											         ...
											         <td>
											         	...
											         	<a href="<?php echo U('Index/showBDcontent?fid='.$vo[FID].'');;?>">
											         		<?php echo ($vo["FNAME"]); ?>		
											         	</a>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showBDList?type=1100&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showBDList?type=1101&p=1');;?>" class="btn btn-default">冒险</a>
		            <a href="<?php echo U('Index/showBDList?type=1102&p=1');;?>" class="btn btn-default">动作</a>
		            <a href="<?php echo U('Index/showBDList?type=1103&p=1');;?>" class="btn btn-default">犯罪</a>
		            <a href="<?php echo U('Index/showBDList?type=1104&p=1');;?>" class="btn btn-default">动画</a>
		            <a href="<?php echo U('Index/showBDList?type=1105&p=1');;?>" class="btn btn-default">家庭</a>
		            <a href="<?php echo U('Index/showBDList?type=1106&p=1');;?>" class="btn btn-default">爱情</a>
		            <a href="<?php echo U('Index/showBDList?type=1107&p=1');;?>" class="btn btn-default">奇幻</a>
		            <a href="<?php echo U('Index/showBDList?type=1108&p=1');;?>" class="btn btn-default">恐怖</a>
		            <a href="<?php echo U('Index/showBDList?type=1109&p=1');;?>" class="btn btn-default">剧情</a>
		            <a href="<?php echo U('Index/showBDList?type=1110&p=1');;?>" class="btn btn-default">科幻</a>
		            <a href="<?php echo U('Index/showBDList?type=1111&p=1');;?>" class="btn btn-default">悬疑</a>
		            <a href="<?php echo U('Index/showBDList?type=1112&p=1');;?>" class="btn btn-default">战争</a>
		            <a href="<?php echo U('Index/showBDList?type=1113&p=1');;?>" class="btn btn-default">悬念</a>
		            <a href="<?php echo U('Index/showBDList?type=1114&p=1');;?>" class="btn btn-default">喜剧</a>
		            <a href="<?php echo U('Index/showBDList?type=1115&p=1');;?>" class="btn btn-default">惊悚</a>
		            <a href="<?php echo U('Index/showBDList?type=1116&p=1');;?>" class="btn btn-default">传记</a>
		            <a href="<?php echo U('Index/showBDList?type=1117&p=1');;?>" class="btn btn-default">合集</a>
		            <a href="<?php echo U('Index/showBDList?type=1118&p=1');;?>" class="btn btn-default">综艺</a>
		            <a href="<?php echo U('Index/showBDList?type=1119&p=1');;?>" class="btn btn-default">电视剧/a>
		            <a href="<?php echo U('Index/showBDList?type=1120&p=1');;?>" class="btn btn-default">其它</a>
