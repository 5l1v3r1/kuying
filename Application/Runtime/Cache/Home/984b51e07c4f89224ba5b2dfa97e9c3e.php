  ...
  <body style=" FONT-FAMILY: 微软雅黑">
    ...
    <div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="margin-top:40px;margin-bottom:0px;padding:0px;background-color:white;"    draggable="true">
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
    		<h3><img src="/kuying/Public/img/icon/map.gif">720pBT分享专区<small> 发掘，提供，分享 we do it</small></h3>	
      </div>
    		<!--left-->
    	<div class="container" style="padding:0px;margin-top:0px;margin-bottom:0px;" >
      	<!--left-->
      	<div class="col-md-10" style="padding-left:5px;margin-left:0px;" >
      		<h6>
	      		...
	      		<a href="<?php echo U('Index/showHDList?type=1700&p=1');;?>">720pBT分享专区</a>
	      	</h6>
	      	<hr>
	        ...
	        <h4 color="#fafafa"><img src="/kuying/Public/img/icon/resourcelist.gif">全部资源</h4>
								<a href="<?php echo U('Index/showHDList?type=1700&p=1');;?>" class="btn btn-default">全部</a>
		            <a href="<?php echo U('Index/showHDList?type=1701&p=1');;?>" class="btn btn-default">冒险</a>
		            <a href="<?php echo U('Index/showHDList?type=1702&p=1');;?>" class="btn btn-default">动作</a>
		            <a href="<?php echo U('Index/showHDList?type=1703&p=1');;?>" class="btn btn-default">犯罪</a>
		            <a href="<?php echo U('Index/showHDList?type=1704&p=1');;?>" class="btn btn-default">动画</a>
		            <a href="<?php echo U('Index/showHDList?type=1705&p=1');;?>" class="btn btn-default">家庭</a>
		            <a href="<?php echo U('Index/showHDList?type=1706&p=1');;?>" class="btn btn-default">爱情</a>
		            <a href="<?php echo U('Index/showHDList?type=1707&p=1');;?>" class="btn btn-default">奇幻</a>
		            <a href="<?php echo U('Index/showHDList?type=1708&p=1');;?>" class="btn btn-default">恐怖</a>
		            <a href="<?php echo U('Index/showHDList?type=1709&p=1');;?>" class="btn btn-default">剧情</a>
		            <a href="<?php echo U('Index/showHDList?type=1710&p=1');;?>" class="btn btn-default">科幻</a>
		            <a href="<?php echo U('Index/showHDList?type=1711&p=1');;?>" class="btn btn-default">悬疑</a>
		            <a href="<?php echo U('Index/showHDList?type=1712&p=1');;?>" class="btn btn-default">战争</a>
		            <a href="<?php echo U('Index/showHDList?type=1713&p=1');;?>" class="btn btn-default">悬念</a>
		            <a href="<?php echo U('Index/showHDList?type=1714&p=1');;?>" class="btn btn-default">喜剧</a>
		            <a href="<?php echo U('Index/showHDList?type=1715&p=1');;?>" class="btn btn-default">惊悚</a>
		            <a href="<?php echo U('Index/showHDList?type=1716&p=1');;?>" class="btn btn-default">传记</a>
		            <a href="<?php echo U('Index/showHDList?type=1717&p=1');;?>" class="btn btn-default">合集</a>
		            <a href="<?php echo U('Index/showHDList?type=1718&p=1');;?>" class="btn btn-default">综艺</a>
		            <a href="<?php echo U('Index/showHDList?type=1719&p=1');;?>" class="btn btn-default">电视剧</a>
		            <a href="<?php echo U('Index/showHDList?type=1720&p=1');;?>" class="btn btn-default">其它</a>
