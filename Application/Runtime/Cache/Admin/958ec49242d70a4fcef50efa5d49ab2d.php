...
$(function()
{
	...
	$.extend({'getInfo':function(id){
		$.pdialog.open("/kuying/index.php/Admin/Hdzy/showinfo/id/"+id,"dialog","查看会员信息",{maxable:false,mask:true,width:500,height:300});
	}});
});
</script>
...
<div class="pageHeader">
	<form id="pagerForm" action="/kuying/index.php/Admin/Hdzy" method="post" onsubmit="return navTabSearch(this)">
    	<input type="hidden" name="pageNum" value="<?php echo ($currentPage); ?>" />
        <input type="hidden" name="numPerPage" value="<?php echo ($numPerPage); ?>" />
        <input type="hidden" name="handle_name" value="admin_hdzy_index" />
    	<div class="searchBar">
...
<div class="pageContent">
    ...
    <div class="panelBar">
    	<ul class="toolBar">
        	<li><a class="add" href="/kuying/index.php/Admin/Hdzy/add/navTabId/<?php echo (strtolower(CONTROLLER_NAME)); ?>_<?php echo (strtolower(ACTION_NAME)); ?>" target="dialog" rel="hdfilm_add" mask="true" maxable="true" minable="true"  width="550" height="380"><span>新增</span></a></li>
            <li><a class="delete" href="/kuying/index.php/Admin/Hdzy/foreverdelete/navTabId/<?php echo (strtolower(CONTROLLER_NAME)); ?>_<?php echo (strtolower(ACTION_NAME)); ?>" posttype="string" rel="id" target="selectedTodo" title="确定要删除选中的记录吗？" warn="请至少选择一位用户"><span>删除</span></a></li>
            <li><a class="edit" href="/kuying/index.php/Admin/Hdzy/edit/id/{sid_user}" target="dialog" mask="true" maxable="true" minable="true"  warn="请选择一条记录" width="550" height="380" rel="hdfilm_edit" ><span>编辑</span></a></li>
            ...
            <li class="line"></li>
            <li><a class="icon" href="/kuying/index.php/Admin/Hdzy/password/id/{sid_user}" target="dialog" mask="true" maxable="false" warn="请选择一条记录" width="420" height="200"><span>修改密码</span></a></li>
        </ul>
    </div>
    <!--操作按钮结束-->
