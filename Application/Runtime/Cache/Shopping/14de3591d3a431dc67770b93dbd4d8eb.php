   		...
   		<div class="jumbotron visible-lg visible-md visible-sm visible-xs" style="padding:0px;margin-top:10px;margin-bottom:0px;background-color:white;"  draggable="true">
		        ...
		        <div class="row">
		        	<h6>
			      		...
			      		<a href="<?php echo U('Zones/showOther?z_sort=3');;?>" >电影小玩意</a>
			      		<?php echo ($list['TITLE']); ?>
			      	</h6>
		        	<div class="col-md-9">	
		        		<div class="col-md-12">
		        			<div class="panel-heading" style="background-color:#EEEEEE">
								      <h2 class="panel-title"><span class="glyphicon glyphicon-th" ></span> <strong>电影小玩意</strong></h2>
									</div>
									<img width="100%" src = "/kuying/Public/img/loveshop/listtop/filmtop.gif" />
			        			...
			        			<div class="col-md-3" style="padding:0px">
			        				<div style="border:1px solid #DDDDDD;margin:5px;padding:5px">
				        				<a target= _blank href="<?php echo U('Index/showGood?id='.$vo['id'].'');;?>">
					        				<img style="height:180px;width: 100%" src="http<?php echo ($str[1]); ?>" />
